...
export default function SideBar() {
    return (
        <aside className={"group flex flex-col w-12.5 hover:w-50 duration-300 ease-in-out h-screen bg-linear-to-b from-[#9D96B2] to-[#636D9E] absolute z-1000 drop-shadow-lg border-r"}>
            ...
            <div className="flex flex-col">
                ...
                <div className={"flex flex-col py-2"}>
                    <Link href={"/characters"} className={"relative group flex w-full items-center py-2 group/character"}>
